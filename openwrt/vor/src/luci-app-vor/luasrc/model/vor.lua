-- LuCI CBI Model for Vor Configuration
-- Form definition at: /admin/services/vor/config

local m, s, o

m = Map("vor", translate("Vor VPN"),
...
o = s:option(Flag, "enabled", translate("Enable"),
    translate("Enable Vor VPN service"))
o.default = "0"
o.rmempty = false
...
-- Server settings
s = m:section(TypedSection, "vor", translate("Server Configuration"))
s.anonymous = true
s.addremove = false
...
-- Network settings
s = m:section(TypedSection, "vor", translate("Network Settings"))
s.anonymous = true
s.addremove = false
...
-- DNS settings
s = m:section(TypedSection, "vor", translate("DNS Settings"))
s.anonymous = true
s.addremove = false
...
-- Security settings
s = m:section(TypedSection, "vor", translate("Security Settings"))
s.anonymous = true
s.addremove = false
...
s = m:section(TypedSection, "vor", translate("Split Tunnel - Excluded Iranian IPs"))
s.anonymous = true
s.addremove = false
